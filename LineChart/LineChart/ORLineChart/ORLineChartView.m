...
- (void)reloadData {
    ...
    for (int i = 0; i < items; i ++) {
        ...
        horizontal.title = [[NSAttributedString alloc] initWithString:[NSString stringWithFormat:@"%@", self.xValue[i]] attributes:[_dataSource labelAttrbutesForHorizontalOfChartView:self]];

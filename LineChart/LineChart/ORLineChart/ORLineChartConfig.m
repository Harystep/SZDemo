...
- (void)_or_initData {
    ...
    self.gradientColors = @[[UIColor lightTextColor]];
//    @[[[UIColor redColor] colorWithAlphaComponent:0.3], [[UIColor blueColor] colorWithAlphaComponent:0.3]];

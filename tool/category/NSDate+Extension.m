...
+ (NSString *)increaseDateFormDate:(NSString *)currentDate {
    
    NSDate *dates = [NSDate date:currentDate WithFormat:@"yyyy-MM-dd"];
    
    NSTimeInterval interval = 24*60*60*1;
    
    NSDate *date = [[NSDate alloc] initWithTimeInterval:interval sinceDate:dates];
...
+ (NSString *)increaseMonthFormDate:(NSString *)currentDate {
    
    NSDate *dates = [NSDate date:currentDate WithFormat:@"yyyy-MM"];
    
    NSTimeInterval interval = 24*60*60*30*2;
    
    NSDate *date = [[NSDate alloc] initWithTimeInterval:interval sinceDate:dates];
    
    NSString *dateStr = [date stringWithFormat:@"yyyy-MM"];
    
    return dateStr;
}

+ (NSString *)reduceDateFormDate:(NSString *)currentDate {
...
+ (NSString *)reduceMonthFormDate:(NSString *)currentDate {
    
    NSDate *dates = [NSDate date:currentDate WithFormat:@"yyyy-MM"];
    NSCalendar *calendar = [[NSCalendar alloc] initWithCalendarIdentifier:NSCalendarIdentifierGregorian];
    NSDateComponents *lastMonthComps = [[NSDateComponents alloc] init];
    [lastMonthComps setMonth:-1];
    NSDate *newdate = [calendar dateByAddingComponents:lastMonthComps toDate:dates options:0];
    NSString *dateStr = [newdate stringWithFormat:@"yyyy-MM"];
    return dateStr;
}

+ (NSString *)reduceDateFormDate:(NSString *)currentDate days:(NSInteger)days {
    
    NSDate *dates = [NSDate date:currentDate WithFormat:@"yyyy-MM-dd"];
    
    NSTimeInterval interval = 24*60*60*1*days;
...
+ (NSString *)increaseDateFormDate:(NSString *)currentDate days:(NSInteger)days {
...
+ (NSString *)stringFormDate:(NSString *)currentDate {
    
    NSDate *dates = [NSDate date:currentDate WithFormat:@"yyyyMMdd"];
...
+ (NSString *)increaseDateAfterOneDay:(NSString *)currentDate {
    
    NSDate *dates = [NSDate date:currentDate WithFormat:@"yyyy-MM-dd"];
    
    NSTimeInterval interval = 24*60*60*1 - 1;
...
//    NSString *nowtimeStr = [dateFormatter stringFromDate:datenow];//----------将nsdate按formatter格式转成nsstring
//    NSLog(@"%@", nowtimeStr);
    // 时间转时间戳的方法:
